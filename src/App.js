...
class App extends Component {
  ...
  addNewStudent()
  {
this.props.addStudent({id:Math.max(...this.props.studentList.map(function(o){return o.id})) + 1,name:'',performance:'',birthDay:''});
  }
  ...
  editStudentSubmit(id,name,performance,birthDay)
  {
this.props.updateStudent({id:id,name:name,performance:performance,birthDay:birthDay});
  }
  render() {
    return (
  ...
  <table className="table table-hover">
          <thead className="thead-dark"><tr><th>Name</th><th>Performance</th><th>Date of Birth</th><th>Edit/Save</th><th>Delete</th></tr></thead>
